...
const Skills = () => {
  return (
    ...
    <div className="max-w-7xl mx-6 px-4 sm:px-6 sm:mx-auto lg:px-8">
        ...
        <div className="text-black dark:text-white mb-4 lg:text-center">
        <h2 className="text-base text-accent font-semibold tracking-wide uppercase"  data-aos="fade-in"
          data-aos-duration="3000">
          My Skills
        </h2>
        <p className="mt-2 text-3xl leading-8 text-gray-700 dark:text-white font-medium tracking-tight sm:text-4xl"  data-aos="fade-in"
          data-aos-duration="3000">
          {"{"} Skills {"}"}
        </p>
      </div>
          ...
          data-aos-duration="3000">
            <div className="grid mb-6 grid-cols-12 gap-8 sm:gap-12 md:grid-cols-12 lg:grid-cols-12 text-gray-400">
              {skills.map((skill,i) => (
                <a href='' key={i} className="text-xl sm:text-3xl text-black dark:text-white flex justify-center items-center ml-4">
                  {skill.icon}
                </a>
              ))}
            </div>
