...
const Pricing = () => {
  return (
   <>
<section className="text-gray-400 bg-transparent dark:bg-gray-900  body-font overflow-hidden p-0 sm:p-12" id='pricing'>
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
    <h2 className="text-base text-accent font-semibold tracking-wide uppercase" data-aos="flip-right">
             My Pricing
            </h2>
            <p className="mt-2 text-gray-700 dark:text-white text-3xl leading-8 font-medium tracking-tight sm:text-4xl" data-aos="fade-in">
              {"{"} Pricing {"}"}
            </p>
      <div className="flex mx-auto border-2 border-indigo-500 rounded overflow-hidden mt-6" data-aos="fade-in">
        <button className="py-1 px-4 bg-indigo-500 text-white focus:outline-none">Full</button>
        <button className="py-1 px-4 text-black dark:text-gray-300 focus:outline-none">Stack</button>
      </div>
    </div>
    <div className="flex flex-wrap -m-4">

      <div className="p-4 xl:w-1/3 md:w-1/2 w-full" data-aos="fade-in">
        <div className="h-full p-6 rounded-lg border-2 border-indigo-500 flex flex-col relative overflow-hidden">
          ...
          <h1 className="text-4xl text-black dark:text-white leading-none flex items-center pb-4 mb-4 border-b border-gray-800">
            <span>30,100 Rs</span>
          </h1>
          ...
          <a href="https://api.whatsapp.com/send/?phone=9816328430&text&type=phone_number&app_absent=0">
      ...
      <div className="p-4 xl:w-1/3 md:w-1/2 w-full" data-aos="fade-in">
        <div className="h-full p-6 rounded-lg border-2 border-gray-700 flex flex-col relative overflow-hidden">
          ...
          <h1 className="text-4xl leading-none flex items-center pb-4 mb-4 border-b border-gray-800 text-black dark:text-white">
            <span>59,999 Rs.</span>
          </h1>
          <p className="flex items-center text-gray-400 mb-2">
            <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-800 text-gray-500 rounded-full flex-shrink-0">
